...
// Container principal da seção, com imagem de fundo
export const Container = styled.section`
  ...
  background-position: self-start;
...
export const Content = styled.div`
  position: relative;
  z-index: 1; // Garante que o conteúdo fique na frente de qualquer elemento de fundo
  display: flex;
